...
width: 100%;
  height: 100vh;
  background-image: linear-gradient(rgba(0,168,255,0.3), rgba(0,168,255,0.3)), url(../images/demo.jpg);
  background-repeat: no-repeat;
  background-size: 100% 100%;
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         <a class="dropdown-item" href="about.php">Dance</a>
          <a class="dropdown-item" href="#">Singing</a>
          <a class="dropdown-item" href="#">Acting</a>
          <a class="dropdown-item" href="#">Event Activity</a>
          <a class="dropdown-item" href="#">Fastive Activity</a>
        </div>
      </li>
...
<h2 class="font-weight-bold" >ST.AUGUSTINE CO-ED SCHOOL</h2><h3><em>ACTIVITIES</em></h3>
...
<p class="text-capitalize pt-1"> our school participants says</p>
</div>
...
<div class="box">
<a href="#"><img src="../images/f.jpg" class="img-fluidi img-thumbnali"></a>
<h1> samayra</h1>
<h2>singing</h2>
<p class="m-4">ncdlwqkldmlkw cfguewgij  bDCwhw0 hdncjdhkwe</p>
...
<div class="col-lg-4 col-md-4 col-12">
<div class="box">
<a href="#"><img src="../images/h.jpg" class="img-fluidi img-thumbnali"></a>
<h1> samayra</h1>
<h2>singing</h2>
<p class="m-4">ncdlwqkldmlkw cfguewgij  bDCwhw0 hdncjdhkwe</p>
...
<form action="userinfo.php" method="post">
  ...
  <div class="form-group">
    <input type="number" class="form-control" id="mobile" required autocomplete="off" placeholder="Enter Your Mobile Number">
     ...
     <div class="form-group">
     <label>comment</label>
  <textarea class="form-control" rows="4" id="comment" placeholder="Enter Your Massage"></textarea>
</div>
...
<li><a href="#">BANEFITS</a></li>
<li><a href="#">ABOUT</a>
</li>
</div>
</div>

<div class="col-lg-4 col-md-12 col-15 footer-div">
<div>
<h3> NEWS LETTER</h3>
